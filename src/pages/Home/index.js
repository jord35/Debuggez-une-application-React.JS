...
const Page = () => {
  ...
  return <>
    ...
    <main>
      ...
      <section className="EventsContainer" data-testid="event-render">
      ...
      <section className="PeoplesContainer">
        ...
        <div className="ListContainer" data-testid="people-render">
          <PeopleCard
    ...
    <footer className="row" data-testid="footer-render">
      <div className="col presta">
        <h3>Notre derniére prestation</h3>
        {/* Vérification de `last` avant l'appel pour éviter une erreur "undefined" */}
        {last ? (
          <EventCard
            imageSrc={last.cover}
            title={last.title}
